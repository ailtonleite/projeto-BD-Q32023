...
('Josias J', '54321987600', 'josiasj@email.com', '05528955555555');


INSERT INTO `dbprojetod`.`tb_endereco`
(`nome_rua`,`bairro`,`numero`,`complemento`,`cidade`,`estado`,`cep`,`tb_usuario_id_usuario`)
VALUES
...
(`nota_geral`,`tb_endereco_num_seq`,`tb_endereco_tb_usuario_id_usuario`,`tb_carteira_id_carteira`)
VALUES
(0.0, 2, 4, 1),
(9.5, 3, 5, 2),
(0.0, 5, 2, 3);
...
(`tb_tipopedido_id_tipo`,`tb_designer_id_designer`)
VALUES
(1, 1),
(2, 1),
(1, 2),
...
(`status`,`dimensao`,`descricao`,`data_inicio`,`data_estimada`,`data_fim`,`tb_usuario_id_usuario`,`tb_designer_id_designer`,`tb_tipopedido_id_tipo`,`tb_tipopagamento_id_tipopagamento`)
VALUES
...
(`link_midia`,`tb_pedido_num_pedido`)
VALUES
